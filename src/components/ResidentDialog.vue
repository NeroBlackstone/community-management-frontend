<template>
    <div>
        <v-toolbar>
            <v-toolbar-title>Community Population Management</v-toolbar-title>
            ...
            <v-dialog v-model="dialog">
                <template #activator="{on}">
                    <v-btn color="primary" v-on="on">New {{itemName}}</v-btn>
                </template>
                <v-card>
                    <v-card-title>
                    ...
                    <v-card-text>
                        ...
                        <v-container grid-list-md>
                            ...
                            <v-layout wrap>
                                ...
                                <v-flex xs12 sm6 md4>
                                    <v-select :items="selectSex" label="Sex" v-model="editedItem.sex"></v-select>
                                </v-flex>
                            </v-layout>
                            <h2>Address</h2>
                            <v-layout wrap>
                                <v-flex xs12 sm6 md4>
                                    <v-text-field
                                            ...
                                            :rules="[() => !!editedItem.address.building || 'This field is required']"
                                    >
                                    </v-text-field>
                                </v-flex>
                                <v-flex xs12 sm6 md4>
                                    <v-text-field
                                            ...
                                            label="unit number"
                                            :rules="[() => !!editedItem.address.unit || 'This field is required']"
                                    >
                                    </v-text-field>
                                </v-flex>
                                <v-flex xs12 sm6 md4>
                                    <v-text-field
                                            ...
                                            label="room number"
                                            :rules="[() => !!editedItem.address.room || 'This field is required']"
                                    >
                                    </v-text-field>
                                </v-flex>
                            </v-layout>
...
<script>
    ...
    export default {
        ...
        computed:{
            formTitle(){
                return this.editedId === -1 ? `New ${this.itemName}` : `Edit Item ${this.itemName}`
            },
        },
        methods:{
            close(){
